...
export default function Checkout() {
  ...
  /*
   * IMPORTANT:
   * This function ONLY starts the Paystack payment.
   *
   * It does NOT mark the order as paid.
   *
   * The Paystack webhook will later confirm the payment.
   */
  const handlePay = async () => {
    ...
    try {
      /*
       * Generate our internal order number.
       *
       * Paystack itself will generate the real payment reference
      ...
      const order = await createOrder(
        {
          ...
          /*
           * IMPORTANT:
           * Do NOT create a fake payment reference here.
           *
           * Paystack will generate the real reference.
           */
          payment_ref: null,
      ...
      /*
       * STEP 2
       * Ask our Supabase Edge Function to initialize Paystack.
       *
       * The secret Paystack key NEVER enters this React application.
       */
      ...
      /*
       * STEP 3
       * Remember the pending order.
       *
       * This is useful when the customer returns from Paystack.
       */
   ...
   * IMPORTANT:
   *
   * We do not show "Order Confirmed" here after clicking Pay.
   *
   * The customer has not necessarily paid yet.
   *
   * Your Paystack callback/payment verification page should
   * eventually set the completed state after the server confirms
   * the payment.
   */
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="flex items-start gap-3 p-4 rounded-xl bg-ink-900/50 mb-6">
                ...
                <p className="text-xs text-ink-400">
                  Your payment is secured by Paystack. We never store
                  your card details. Payment is verified server-side
